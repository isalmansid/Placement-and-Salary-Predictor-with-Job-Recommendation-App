...
model = pickle.load(open('SP_DT.pkl','rb'))

app = Flask(__name__)

@app.route('/')
def index():
    return "Greeetings from Mohd. Salman"
...
def predict():
    ...
    input_query = np.array([[Branch,SSC,HSC,Degree_Sem_1_Cgpa,Degree_Sem_2_Cgpa,Degree_Sem_3_Cgpa,Degree_Sem_4_Cgpa,Degree_Sem_5_Cgpa,Programming_Skills,Communication_Skills_Out_Of_5,English_Grammar_Out_Of_5]])
