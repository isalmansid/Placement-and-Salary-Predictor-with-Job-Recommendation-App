...
public class PlacementActivity extends AppCompatActivity {
    ...
    String url = "https://saysalman.pythonanywhere.com/predict";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        predict.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST,url,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if(data.equals("1")){
                                        result.setText("Placement Successful!");
                                    }else{
                                        result.setText("Placement Failed! Better luck next time.");
                                    }
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(PlacementActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                            }
                        }){
                ...
                RequestQueue queue = Volley.newRequestQueue(PlacementActivity.this);
